        ...
        me.columns  = [
			...
			{ 
                ...
                tpl         : new Ext.XTemplate(
                    ...
                    "<tpl if='cloud_wide == false'><div class=\"fieldRed\"><i class=\"fa fa-times-circle\"></i> "+i18n("sNo")+"</div></tpl>"
                ),
				filter      : {
                    type            : 'boolean',
                    defaultValue    : false,
			...
			{ 
				...
				xtype       : 'templatecolumn', 
                tpl         : new Ext.XTemplate(
                    "<tpl if='ap_profile_id'><div class=\"fieldGreen\"><i class=\"fa fa-connectdevelop\"></i> {ap_profile_name}</div>",
                    "<tpl else>",
