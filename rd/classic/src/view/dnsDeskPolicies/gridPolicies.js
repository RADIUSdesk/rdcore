Ext.define('Rd.view.dnsDeskPolicies.gridPolicies' ,{
    extend      :'Ext.grid.Panel',
    alias       : 'widget.gridPolicies',
    multiSelect : true,
    stateful    : true,
    stateId     : 'StateGridF',
    ...
    urlMenu     : '/cake3/rd_cake/dns-desk-policies/menu-for-grid.json',
    plugins     : [
        'gridfilters',
        {
            ptype: 'rowexpander',
    ...
    initComponent: function(){
        var me      = this; 
        me.store    = Ext.create(Rd.store.sDnsDeskPolicies);
