Ext.define('Rd.view.firewallProfiles.winFirewallProfileEntryEdit', {
    extend      : 'Ext.window.Window',
    alias       : 'widget.winFirewallProfileEntryEdit',
    closable    : true,
    draggable   : true,
    resizable   : true,
    title       : 'Edit Firewall Profile Entry',
    width       : 600,
    height      : 500,
    plain       : true,
    border      : false,
    ...
    initComponent: function() {
        var me 		= this; 
        me.setTitle('Edit Firewall Profile Entry For '+me.firewall_profile_name);
        var frmData = Ext.create('Ext.form.Panel',{
            ...
            items: [
                {
                    xtype   : 'textfield',
                    name    : 'firewall_profile_entry_id',
                    value   : me.firewall_profile_entry_id,
                    hidden  : true
                },
                {
                    xtype   : 'textfield',
