                ...
                '<div class="plain-wrap">',
                	...
                	'<tpl if="type==\'firewall_profile_entry\'">',
                		'<div class="sub">',
                			...
                			'</div>', 
                			'<tpl if="schedule!==\'always\'">',               				
		            			'<div style="font-size:15px;color:#287160;text-align:left;padding-left:20px;padding-top:10px;"><i class="fa fa-clock-o"></i> {start_time_human} to {end_time_human} ({human_span})</div>',
		            		'</tpl>',
		            		'<tpl if="schedule==\'one_time\'">',               				
