Ext.define('Rd.view.wireguardServers.winWireguardServerAddWizard', {
    extend      : 'Ext.window.Window',
    alias       : 'widget.winWireguardServerAddWizard',
    closable    : true,
    draggable   : true,
    resizable   : true,
    title       : 'New Wireguard Server',
    width       : 450,
    height      : 500,
    plain       : true,
    border      : false,
    ...
    //_______ Data for Wireguard Servers  _______
    mkScrnData: function(){
