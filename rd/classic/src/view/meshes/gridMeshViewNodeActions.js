    ...
    columns: [
     //   {xtype: 'rownumberer',stateId: 'StateGMVNA1'},
        { 
            ...
            dataIndex   : 'action',stateId: 'StateGMVNA2'
        },
        { 
            text        : i18n('sStatus'),
            flex        : 1,
            ...
            dataIndex   : 'status',stateId: 'StateGMVNA3'
        },
        { text: i18n('sCommand'),    dataIndex: 'command',       tdCls: 'gridTree', flex: 1, sortable: true,stateId: 'StateGMVNA4'},
        { 
            text        : 'Created',
            dataIndex   : 'created', 
            tdCls       : 'gridTree', 
