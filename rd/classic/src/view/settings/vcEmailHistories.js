Ext.define('Rd.view.settings.vcEmailHistories', {
    extend  : 'Ext.app.ViewController',
    alias   : 'controller.vcEmailHistories',
    init    : function() {
    
    },
    config: {
        urlDelete       : '/cake4/rd_cake/settings/email-histories-delete.json',
    },
    control: {
        'gridEmailHistories #reload': {
            click   : 'reload'
        },     
        'gridEmailHistories #delete': {
            click   : 'del'
        }
    },
    reload: function(){
