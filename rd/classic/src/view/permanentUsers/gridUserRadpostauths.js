Ext.define('Rd.view.permanentUsers.gridUserRadpostauths' ,{
    ...
    urlMenu: '/cake4/rd_cake/permanent-users/menu-for-authentication-data.json',
    ...
    initComponent: function(){
        ...
        me.store = Ext.create('Ext.data.Store',{
            ...
            proxy: {
                ...
                format  : 'json',
                batchActions: true, 
                url     : '/cake4/rd_cake/radpostauths/index.json',
                ...
                api: {
                    destroy  : '/cake4/rd_cake/radpostauths/delete.json'
                },
