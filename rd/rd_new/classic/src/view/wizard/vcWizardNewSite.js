Ext.define('Rd.view.wizard.vcWizardNewSite', {
    ...
    config : {
        ...
        infoOne :'\
            ...
            <p>\
            <b>Step 1</b> contains the basic information needed to create a new Cloud.<br>\
            When the wizard is complete you can simply add Access Points to your networks and you are good to go!\
            </p>\
            <p>\
            <font color="green"><big><b>Adding a new Cloud should take no longer than 5 minutes!</b></big>!</font>\
            </p>\
            <p>\
            ...
            Let’s assume you sign up a hotel chain called <big><b>Royal Hotel</b></big>. Then the following items will be created.\
            </p>\
            <p>\
            <big>Cloud</big><br>\
            ...
            <p>\
            <big>Realm</big><br>\
              Called <b>Royal Hotel</b> owned by the <b>Royal Hotel</b> Cloud\
            </p>\
            <p>\
            ...
            <big>Access Point Profile</big><br>\
              Called <b>Royal Hotel</b> (APdesk) owned by the <b>Royal Hotel</b> Cloud.<br>\
            ...
            <big>Mesh Network</big><br>\
             Called <b>Royal Hotel</b> (MESHdesk) owned by the <b>Royal Hotel</b> Cloud.<br>\
                <small>Open SSID callled <b>Royal Hotel Guest</b> that has a login page (Captive Portal).</small><br>\
                <small>Secure SSID called <b>Royal Hotel Wireless</b> that is bridged to the LAN.</small><br>\
            </p>\
            <p>\
            <big>Permanent User</big><br>\
              Called <b>royal_hotel</b> with password as <b>designated</b> owned by the <b>Royal Hotel</b> Cloud\
            </p>\
            <p>\
            <big>Permanent User</big><br>\
              Called <b>click_to_connect@royal_hotel</b> with password as <b>click_to_connect</b> owned by the <b>Royal Hotel</b> Cloud\
            </p>\
        ',
        infoTwo : '\
