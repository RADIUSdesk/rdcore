Ext.define('Rd.view.dynamicDetails.vcDynamicDetailTranslations', {
    ...
    config: {
        ...
        urlEditLanguage : '/cake4/rd_cake/dynamic-detail-translations/edit-language.json',
        urlDelLanguage  : '/cake4/rd_cake/dynamic-detail-translations/del-language.json',
        urlAddKey       : '/cake4/rd_cake/dynamic-detail-translations/add-key.json',
        urlEditKey      : '/cake4/rd_cake/dynamic-detail-translations/edit-key.json',
        urlDelKey       : '/cake4/rd_cake/dynamic-detail-translations/del-key.json',
        urlAddPhrase    : '/cake4/rd_cake/dynamic-detail-translations/add-phrase.json',
        urlExistingChk  : '/cake4/rd_cake/dynamic-detail-translations/existing-check.json',
        urlDelPhrase    : '/cake4/rd_cake/dynamic-detail-translations/del-phrase.json',
        urlPreviewApi   : '/cake4/rd_cake/dynamic-detail-translations/get-translations.json',
    }, 
    control: {
