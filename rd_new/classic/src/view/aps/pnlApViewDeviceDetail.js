Ext.define('Rd.view.aps.pnlApViewDeviceDetail', {
    extend      : 'Ext.panel.Panel',
    alias       : 'widget.pnlApViewDeviceDetail',
    scrollable  : true,
    layout: {
        type    : 'vbox',
        align   : 'stretch'
                    ...
                    "<div>",   
                        '<ul class="fa-ul">',    
                            "<li style='color:#3c6cb7;'><i class='fa-li fa  fa-tablet'></i>{mac}",
                                ...
                                "</tpl>",
                            "</li>",
                            "<li style='color:#238080;'><i class='fa-li fa fa-wifi'></i> {ap_profile_entry.name}",               
                                ...
                                ")</span>",
                            "</li>",
                            "<li><i class='fa-li fa  fa-cube'></i> {ap.name}</li>",  
