...
// 10 * * * * www-data cd /var/www/radiusdesk/cake3/rd_cake && bin/cake update_rolling_lasthour >> /dev/null 2>&1
...
// set @in_date = '2018-05-07'; 				-- replace with current date
// call sp_update_rolling_last_hour(@in_date_time,@in_date,@dead_seconds,@nms,@ins_err_cnt,@err_update_cnt);
...
class UpdateRollingLasthourShell extends Shell{
    public function main(){
        $this->out("Updating rolling last hour");
        ...
        $this->connection->execute("call sp_update_rolling_last_hour(@in_date_time,@in_date,@dead_seconds,@nms,@ins_err_cnt,@err_update_cnt)");
