...
CREATE OR REPLACE PROCEDURE maintain_user_stats_partitions(
...
BEGIN
    ...
    IF v_exists = 1 THEN
        ...
        SET v_sql = CONCAT(
            'ALTER TABLE user_stats DROP PARTITION ',
            v_part_name
        );
...
call maintain_user_stats_partitions(12,3);


CREATE EVENT IF NOT EXISTS ev_user_stats_partition_maintenance
ON SCHEDULE EVERY 1 DAY
STARTS TIMESTAMP(CURRENT_DATE,'00:15:00')
DO
CALL maintain_user_stats_partitions(
