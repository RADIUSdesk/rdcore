...
$config['nas_types'][3]     = ['name' => 'Cisco-COA',	        'id' => 'Cisco-COA',   	    'active' => true];
$config['nas_types'][4]     = ['name' => 'Coova-On-Meshdesk',	'id' => 'CoovaMeshdesk',   	'active' => true];
$config['nas_types'][5]     = ['name' => 'Juniper-CAO',	        'id' => 'Juniper',   	    'active' => true];
$config['nas_types'][6]     = ['name' => 'Mikrotik-API',	    'id' => 'Mikrotik-API',   	'active' => true];
$config['nas_types'][7]     = ['name' => 'Mikrotik-Rest-API',   'id' => 'Mikrotik-Rest-API','active' => true];
$config['nas_types'][8]     = ['name' => 'Mikrotik-COA',	    'id' => 'Mikrotik-COA',   	'active' => true];
$config['nas_types'][9]     = ['name' => 'Private PSK',	        'id' => 'private_psk',   	'active' => true];
