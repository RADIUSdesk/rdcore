...
$config['nas_types'][2]     = ['name' => 'Cisco-COA',	        'id' => 'Cisco-COA',   	    'active' => true];
$config['nas_types'][3]     = ['name' => 'Coova-On-Meshdesk',	'id' => 'CoovaMeshdesk',   	'active' => true];
$config['nas_types'][4]     = ['name' => 'Juniper-CAO',	        'id' => 'Juniper',   	    'active' => true];
$config['nas_types'][5]     = ['name' => 'Mikrotik-API',	    'id' => 'Mikrotik-API',   	'active' => true];
